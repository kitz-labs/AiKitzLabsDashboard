...
import {
  ...
  Gauge, MessageCircle, Mail, BarChart3, LineChart, ArrowRight, BrainCircuit, Rocket, FolderOpen, Code2, Settings, Github,
} from 'lucide-react';
...
const getNavItems = (language: 'en' | 'de') => [
  ...
  { label: t(language, 'navGithub'), path: '/github', icon: Github },
